class ScoreTarget {
  ...
  factory ScoreTarget.fromValues(String grade, double minScore, double maxScore) {
    // Calculate required exam mark based on grade target
    // Formula: Final Mark = Carry Mark (50%) + Exam Mark (50%)
    // So: Required Exam Mark = (Target Grade - (Carry Mark * 0.5)) / 0.5
  ...
  static List<ScoreTarget> getAllTargets() {
    return [
      ScoreTarget(grade: 'A+', minScore: 90, maxScore: 100, requiredExamMark: 0),
